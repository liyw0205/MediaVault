...
| 08 | `08_remote_mapping_contract.md` | 已完成（1.0.15） | 远程映射变更契约收口 |
| 09 | `09_task_history_cleanup.md` | 已完成（1.0.16） | 任务历史分级清理 |
| 10 | `10_remote_source_action_policy.md` | 已完成（1.0.17） | 远程源操作资格统一 |
