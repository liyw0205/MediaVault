...
- **库维护优先**：新增库诊断、完整问题列表、筛选分页、源健康、刮削证据和 TMDB 复核队列，先解决重复、失效、未匹配、缺封面等可维护性问题。
...
| 库维护 | 在刮削侧栏查看库诊断统计、源健康、完整问题列表、筛选分页和刮削证据，支持打开详情、单条重刮和从媒体库移除问题项 |
...
0.5.x 的库诊断快照写入 `mediavault/library-diagnostics.json`，用于刮削侧栏的库维护统计、源健康、完整问题列表和刮削证据。
