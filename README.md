...
- **0.6.x 体验优先**：首页已新增继续观看、最近入库和观看队列工作流；搜索页已支持观看状态、来源和排序筛选；后续继续围绕合集入口和横屏焦点体验做小步增强。推荐算法、账号、多用户、云同步和 Web 管理端继续后置。
...
| 0.6.x 工作流 | 首页继续观看、最近入库、观看队列、搜索观看状态/来源/排序筛选、可读空状态；后续推进横屏/遥控可用性打磨 |
