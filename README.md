...
- **库维护优先**：新增库诊断、完整问题列表、筛选分页、源健康、远程能力、刮削证据和 TMDB 复核队列，先解决重复、失效、未匹配、缺封面和远程不可解释失败等可维护性问题。
...
| 数据管理 | 应用内查看媒体库、刮削记录、封面、远程 prefix/range 缓存占用并清理 |
