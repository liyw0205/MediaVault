...
|------|------|
| 底栏 | 主页、搜索、合集、刮削 |
| 顶栏 | **主页**：重读库、**界面**（手机/TV 网格切换，真 TV 设备锁定 TV）；**刮削**：右上角设置（右侧侧栏，含刮削选项、管理目录、数据清理） |
...
在 **刮削** Tab 点右上角 **设置**，从右侧侧栏可改刮削选项、打开 **管理媒体目录**、**数据占用与清理**。连播在播放器 **列表 → 连播** 中设置。
